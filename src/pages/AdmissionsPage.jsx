  ...
  return (
    <div className="admission-page">
      ...
      <div className="admission-container">
        ...
        <p>
          For detailed information on postgraduate program admissions, specific program syllabi, and 
          fee structures, please visit our <Link to="/courses" className="link">Courses page</Link> or 
          <Link to="/contact" className="link"> Contact us</Link> directly.
        </p>
      </div>
    </div>
  );
